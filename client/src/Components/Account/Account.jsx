  ...
  return loading===true || userLoading===true ?(<Loader /> ):(
    <div className='account'>
        <div className="accountleft">

            {
                posts && posts.length>0 ? (
                  ...
                  ):<Typography variant='h6'>You haven't posted yet</Typography>
            }
        ...
        <div className="accountright">
            ...
            <Button style={{backgroundColor:"#6fdd78"}} onClick={logoutHandler} variant='contained'>Logout</Button>
            
            <Link to="/update/profile">Edit Profile</Link>
            <Link to="/update/password"  >Change Password</Link>

            <Button variant='text' style={{color:"red", margin:"2vmax"}} 
            onClick={deleteProfileHandler} disabled={deleteLoading}
